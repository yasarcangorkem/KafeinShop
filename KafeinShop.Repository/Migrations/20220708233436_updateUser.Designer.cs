...
namespace KafeinShop.Repository.Migrations
{
    ...
    [Migration("20220708233436_updateUser")]
            ...
            modelBuilder.Entity("KafeinShop.Core.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateDate = new DateTime(2022, 7, 9, 2, 34, 35, 980, DateTimeKind.Local).AddTicks(4009),
                            Name = "Fitre kahve 1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreateDate = new DateTime(2022, 7, 9, 2, 34, 35, 981, DateTimeKind.Local).AddTicks(688),
                            Name = "Fitre kahve 2",
                            Price = 200m,
                            Stock = 30
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreateDate = new DateTime(2022, 7, 9, 2, 34, 35, 981, DateTimeKind.Local).AddTicks(709),
                            Name = "Expresso 1",
                            Price = 600m,
                            Stock = 60
                        },
                        new
                        {
                            Id = 4,
                            CategoryId = 2,
                            CreateDate = new DateTime(2022, 7, 9, 2, 34, 35, 981, DateTimeKind.Local).AddTicks(711),
                            Name = "Türk Kahvesi 1",
                            Price = 600m,
                            Stock = 60
                        },
                        new
                        {
                            Id = 5,
                            CategoryId = 2,
                            CreateDate = new DateTime(2022, 7, 9, 2, 34, 35, 981, DateTimeKind.Local).AddTicks(713),
                            Name = "Türk Kahvesi 2",
                            Price = 600m,
                            Stock = 60
                        });
